...
from pipeline_migration.yamleditor import remove_lines_from_file, insert_text_at_line, EditYAMLEntry
...
class TestEditYAMLEntry:
    ...
    @pytest.mark.xfail(reason="TODO: replacing dict value is buggy")
    ...
    @pytest.mark.xfail(reason="TODO: deleting dict value is buggy")
    ...
    @pytest.mark.xfail(reason="TODO: empty dict yaml file is buggy becasue it's flow style")
    def test_operations_with_empty_yaml(self, empty_yaml_file):
        ...
        with open(empty_yaml_file, "r") as f:
            content = f.read()
